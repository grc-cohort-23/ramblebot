...
class LowercaseSentenceTokenizerTest {
     ...
     */
    @Test
    void testTokenizeWithNoCapitalizationButWithPeriod(){
        LowercaseSentenceTokenizer tokenizer = new LowercaseSentenceTokenizer();
        Scanner scanner = new Scanner("this is a lowercase sentence with a period.");
        List<String> tokens = tokenizer.tokenize(scanner);

        assertEquals(List.of("this","is","a","lowercase","sentence","with","a","period","."),tokens);
    }
